...
def train(cfg):
    train_loader = DataLoader(DataSet_Scene(cfg['train_cfg']['data_path'], device = 'cpu', mode = 'train', ablation1 = True, to_drop = cfg['train_cfg']['to_drop']), batch_size=cfg['train_cfg']['batch_size'], shuffle=True)
    val_loader = DataLoader(DataSet_Scene(cfg['train_cfg']['data_path'], device = 'cpu', mode = 'val', ablation1 = True, to_drop = cfg['train_cfg']['to_drop']), batch_size=100, shuffle=False)
    test_loader = DataLoader(DataSet_Scene(cfg['train_cfg']['data_path'], device = 'cpu', mode = 'test', ablation1 = True, to_drop = cfg['train_cfg']['to_drop']), batch_size=100, shuffle=False)
...
if __name__ == "__main__":
    ...
    cfg['train_cfg']['to_drop'] = args.to_drop
    train(cfg)
